...
let transform_from ctx (src : bytes) (src_offset : int) =
  ...
  let rec rounds constants data ctx i a b c d e f g h =
    if i > 7 then begin
      ...
      let t1_hsc = Int32_u.add (Int32_u.add h  (big_sigma1 e )) (ch e  f  g ) in
      let t1     = Int32_u.add (Int32_u.add t1_hsc (aget constants  j   )) (aget data  j   ) in
      ...
      let t1_hsc = Int32_u.add (Int32_u.add g  (big_sigma1 nd)) (ch nd e  f ) in
      let t1     = Int32_u.add (Int32_u.add t1_hsc (aget constants (j+1))) (aget data (j+1)) in
      ...
      let t1_hsc = Int32_u.add (Int32_u.add f  (big_sigma1 nc)) (ch nc nd e ) in
      let t1     = Int32_u.add (Int32_u.add t1_hsc (aget constants (j+2))) (aget data (j+2)) in
      ...
      let t1_hsc = Int32_u.add (Int32_u.add e  (big_sigma1 nb)) (ch nb nc nd) in
      let t1     = Int32_u.add (Int32_u.add t1_hsc (aget constants (j+3))) (aget data (j+3)) in
      ...
      let t1_hsc = Int32_u.add (Int32_u.add nd (big_sigma1 na)) (ch na nb nc) in
      let t1     = Int32_u.add (Int32_u.add t1_hsc (aget constants (j+4))) (aget data (j+4)) in
      ...
      let t1_hsc = Int32_u.add (Int32_u.add nc (big_sigma1 nh2)) (ch nh2 na nb) in
      let t1     = Int32_u.add (Int32_u.add t1_hsc (aget constants (j+5))) (aget data (j+5)) in
      ...
      let t1_hsc = Int32_u.add (Int32_u.add nb (big_sigma1 ng2)) (ch ng2 nh2 na) in
      let t1     = Int32_u.add (Int32_u.add t1_hsc (aget constants (j+6))) (aget data (j+6)) in
      ...
      let t1_hsc = Int32_u.add (Int32_u.add na (big_sigma1 nf2)) (ch nf2 ng2 nh2) in
      let t1     = Int32_u.add (Int32_u.add t1_hsc (aget constants (j+7))) (aget data (j+7)) in
